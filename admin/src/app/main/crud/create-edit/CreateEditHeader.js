...
function CreateEditHeader(props) {
  ...
  return (
    <>
      {module === 'tickets' ? '' :
        <div className="flex flex-col sm:flex-row flex-1 w-full items-center justify-between space-y-8 sm:space-y-0 py-16">
          <div className="flex flex-col items-center sm:items-start space-y-8 sm:space-y-0 w-full sm:max-w-full min-w-0">
            ...
            >
              <Typography
                className="flex items-center sm:mb-12 lg:mb-10"
                component={Link}
                role="button"
                to={`/app/${module}`}
                color="inherit"
